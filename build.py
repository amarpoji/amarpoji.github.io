...
<section id="top" class="mx-auto max-w-[1280px] px-5 md:px-16 pt-36 pb-20 md:pb-28 min-h-screen flex items-center">
  <div class="w-full">
    ...
    <div class="mt-10 flex flex-wrap gap-3">
      ...
      <a href="{github}" target="_blank" rel="noopener" class="border border-paper3 px-6 py-3 rounded font-medium text-muted hover:text-ink hover:border-ink transition-colors">GitHub ↗</a>
    </div>
...
<section id="contact" class="bg-ink text-paper py-24 md:py-32">
  <div class="mx-auto max-w-[1280px] px-5 md:px-16 text-center">
    ...
    <div class="mt-10 flex flex-wrap justify-center gap-3">
      ...
      <a href="{github}" target="_blank" rel="noopener" class="border border-paper/40 px-8 py-3.5 rounded font-medium hover:border-paper transition-colors">GitHub ↗</a>
      <a href="{linkedin}" target="_blank" rel="noopener" class="border border-paper/40 px-8 py-3.5 rounded font-medium hover:border-paper transition-colors">LinkedIn ↗</a>
    </div>
